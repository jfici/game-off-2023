...
func get_input() -> Dictionary:
	return {
		...
		"pause": Input.is_action_just_pressed("ui_cancel") == true
	}
...
func set_direction(hor_direction) -> void:
	...
	animationTree.set("parameters/Move/blend_position", face_direction)
	if hor_direction == 0:
		return
...
func _on_FollowerSpawn1_body_entered(body):
	print("hi")
	print(body)
